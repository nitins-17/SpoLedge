...
function productsPage() {
	...
	if(sport === "cricket") {
		...
		if(kit[1] === '1') {
			...
			document.getElementsByClassName("img-fluid")[0].src = imgSrc + "aus1.jpg";
			document.getElementsByClassName("product-name")[0].textContent = "Ben Johnson";
			document.getElementsByClassName("product-desc")[0].textContent = "After testing positive for drugs for the second time, sprinter Ben Johnson was banned for life by the International Amateur Athletic Federation. Johnson was stripped of his 1988 Olympic gold medal and world record. Johnson's suspension was eventually lifted, but he never proved to be the same elite runner again.";

			document.getElementsByClassName("img-fluid")[1].src = imgSrc + "eng1.jpg";
			document.getElementsByClassName("product-name")[1].textContent = "Marion Jones";
			document.getElementsByClassName("product-desc")[1].textContent = "";

			document.getElementsByClassName("img-fluid")[2].src = imgSrc + "ind1.jpg";
			document.getElementsByClassName("product-name")[2].textContent = "Randy Barnes";
			document.getElementsByClassName("product-desc")[2].textContent = "Marion Jones was a star of the 2000 Summer Olympics, winning five medals. Jones was ultimately stripped of all her medals and eventually admitted to using performance-enhancing drugs before the 2000 Games. Jones received a lifetime ban from the Olympics, but later suited up in the WNBA.";

			document.getElementsByClassName("img-fluid")[3].src = imgSrc + "nz1.jpg";
			document.getElementsByClassName("product-name")[3].textContent = "Tyson Gray";
			document.getElementsByClassName("product-desc")[3].textContent = "";

			document.getElementsByClassName("img-fluid")[4].src = imgSrc + "sa1.jpeg";
			
			document.getElementsByClassName("product-name")[4].textContent = "Dwain Chambers";
			document.getElementsByClassName("product-desc")[4].textContent = "A two-time Olympic medalist in the shot put and world record holder, Randy Barnes is the rare case of an athlete to receive a lifetime ban, but not have his accomplishments erased. Barnes was suspended for steroid use and later pursued a football career but he didn't reached that height in this field.";
			...
			document.getElementsByClassName("product-desc")[5].textContent = "";
	...
	if(kit_temp === 'F2') {
		document.getElementsByClassName("title")[0].textContent = "Football - Cases";
		teams = Array()
		teams.push("Pep Guardiola");
		teams.push("Andre Onana");
		teams.push("Diego Maradona");
		teams.push("Samir Nasri");
		teams.push("Adrian Mutu");
		teams.push("Fernando Couto");

		descs = Array()
		descs.push("Fo2001, Pep Guardiola was still a professional football player and he was slapped with a ban for consuming a banned substance. Playing for Brescia in Italy, Pep was found in violation of consuming Nandrolone, a type of anabolic steroid. The Spaniard received a four-month ban. However, after a successful appeal six years later, the charges were dropped. The Italian National Olympic Committee (CONI), however, reopened the case against the Spaniard, however, all charges were later cleared once again in 2009.r all those haters from FCB, we are 'The Club of the Century'. Hala Madrid!")
		descs.push("")
		descs.push("SThe most recent case of a footballer being banned for violating anti-doping rules is of Andre Onana. The goalkeeper plays for AFC Ajax and was found having taken a medicine allegedly prescribed originally for his wife. The custodian has been slapped with a 12-month ban from all footballing activities, which could hamper his potential move to a big European club in the future. Club managing director, Edwin Van der Sar released a statement following this news which said, “This is a terrible setback, for Andre himself but certainly also for us as a club. We had hoped for a conditional suspension ")
		descs.push("")
		descs.push("Diego Maradona was also at the receiving end of doping controversy, particularly in 1994 during the FIFA World Cup in the United States. The legendary Argentine player was apparently sent home during the tournament after testing positive for five variants of ephedrine, a stimulant banned by FIFA. Three years prior to this incident, he was also banned for 15 months in 1991 for consuming cocaine. It is widely known that Maradone struggled with cocaine addiction long after his career as a player was over as well and he won the world cup for his nation Argentina.")
		descs.push("")
